        ...
        <header className="border-b border-slate-800/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#" className="text-xs uppercase tracking-[0.2em] text-slate-400 hover:text-cyan-300 transition-colors" style={{ fontFamily: "'Space Mono', monospace" }}>dashboard</a>
              <a href="#" className="text-xs uppercase tracking-[0.2em] text-slate-400 hover:text-cyan-300 transition-colors" style={{ fontFamily: "'Space Mono', monospace" }}>team</a>
