...
export const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen w-screen overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative">
      ...
      {/* Nebula blobs */}
      <div
        className="absolute top-[-10%] left-[-5%] w-[60vmax] h-[60vmax] bg-radial opacity-20 blur-3xl"
        style={{
          background:
            "radial-gradient(ellipse, rgba(34,211,238,0.15) 0%, transparent 60%)",
        }}
      />
      <div
        className="absolute bottom-[-15%] right-[-5%] w-[70vmin] h-[70vmin] bg-radial opacity-20 blur-3xl"
        style={{
          background:
        ...
        <main>
          {activeTab === "home" ? (
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
              ...
              <div className="mb-12">
                <p
                  className="text-cyan-400/60 text-xs tracking-[0.3em] uppercase mb-2"
                  style={{ fontFamily: "'Space Mono', monospace" }}
                >
                  &gt; welcome back
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="p-4 rounded-xl border border-slate-700/40 bg-slate-800/20 backdrop-blur-sm hover:border-cyan-400/40 hover:bg-slate-800/40 transition-all duration-200 cursor-default"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                <div className="lg:col-span-2 p-6 rounded-xl border border-slate-700/40 bg-slate-800/20 backdrop-blur-sm">
                  <p
                    className="text-cyan-400/60 text-xs tracking-[0.3em] uppercase mb-4"
                    style={{ fontFamily: "'Space Mono', monospace" }}
                  >
                    &gt; profile information
                  </p>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label
                          className="text-xs text-slate-600 uppercase tracking-wider mb-1 block"
                          style={{ fontFamily: "'Space Mono', monospace" }}
                        >
                          Email
                        </label>
                  ...
                  <button
                    ...
                    className="mt-6 px-4 py-2 text-xs uppercase tracking-[0.2em] bg-gradient-to-r from-cyan-600 to-indigo-600 hover:from-cyan-500 hover:to-indigo-500 text-slate-950 font-semibold rounded-lg transition-all duration-200"
                    style={{ fontFamily: "'Space Mono', monospace" }}
                  >
                    edit profile
                  </button>
              ...
              <div className="p-4 rounded-xl border border-slate-700/40 bg-slate-800/20 backdrop-blur-sm text-center">
                <p
                  ...
                  style={{ fontFamily: "'Space Mono', monospace" }}
                >
                  iris<span className="text-cyan-400">HR</span> v2.4.1 · running
                  on distributed infrastructure · ISO 27001 certified
                </p>
              </div>
            </div>
          ) : activeTab === "employees" ? (
